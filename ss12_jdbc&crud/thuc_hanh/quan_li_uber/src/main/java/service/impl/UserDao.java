...
public class UserDao implements IUserDao {
    ...
    private static final String SELECT_USERS_COUNTRY = "select * from users where country = ?";
    ...
    public List<User> searchUser(String country) {
        ...
        Connection connection = getConnection();
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(SELECT_USERS_COUNTRY);
